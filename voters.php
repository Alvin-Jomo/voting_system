...
<div class="col-lg-6">
    ...
    <center>
        <div class="voters_notice">
            <p style="color:red;"><strong><i>NOTE</i>:</strong> if you did not registered for online voting, your name will not appear on list below and
                            ...
                            <div class="table_back">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="border:none">
                                    ...
                                    <tbody>
										...
										?>
                                      <!-- used to retrieve data from database and insert it into the table -->
											<tr >
