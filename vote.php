...
<body>
	...
	<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
						<?php
							$query = $conn->query("SELECT * FROM `candidate` WHERE `position` = 'President'") or die(mysqli_errno());
							while($fetch = $query->fetch_array())
						{
						?>
                           <div id = "position" style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><center><h4><input type = "radio" value = "<?php echo $fetch['candidate_id'] ?>" name = "pres_id" class = "pres">Give Vote</center></h4></div>
							</div>
				...
				<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary">
						...
						?>
		<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
			<div><center><img class = "image-rounded" src = "admin/<?php echo $fetch['img']?>"style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px"></center></div>
		    <div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
			<div><center><h4><input type = "radio" value = "<?php echo $fetch['candidate_id'] ?>" name = "vp_id" class = "vpres">Give Vote</center></h4></div>
		</div>
						<?php
							}
						?>
	  ...
	  <div class="panel panel-primary">
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center><div></h3></div>
						<div><center><h4><input type = "radio" value = "<?php echo $fetch['candidate_id'] ?>" name = "ua_id" class = "ua">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
						<div><h4><center><input type = "radio" value = "<?php echo $fetch['candidate_id'] ?>" name = "ss_id" class = "ss">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><h4><center><input type = "radio" value = "<?php echo $fetch['candidate_id'] ?>" name = "ea_id" class = "ea">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
						<div><h4><center><input type = "radio"  value = "<?php echo $fetch['candidate_id'] ?>" name = "treasurer_id" class = "treasurer">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><h4><center><input type = "radio" value = "<?php echo $fetch['candidate_id'] ?>" name = "vtr_id" class = "vtr">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><h4><center><input type = "radio"  value = "<?php echo $fetch['candidate_id'] ?>" name = "sg_id" class = "sg">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><h4><center><input type = "radio"  value = "<?php echo $fetch['candidate_id'] ?>" name = "tas_id" class = "tas">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><h4><center><input type = "radio"  value = "<?php echo $fetch['candidate_id'] ?>" name = "ps_id" class = "ps">Give Vote</center></h4></div>
						</div>
            ...
            <div class="panel-body" style = "background-color:inherit; display:block; border:4px solid black">
				...
				?>
						<div id = "position"  style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
							<div><center><img src = "admin/<?php echo $fetch['img']?>" style ="border-radius:6px; border:4px solid black" height = "150px" width = "150px" class = "img"></center></div>
							<div style="color:black"><h3><center><?php echo "<strong>Names: </strong>".$fetch['firstname']." ".$fetch['lastname']."<br/><strong>Gender: </strong> ".$fetch['gender']."<br/><strong>Level: </strong> ".$fetch['year_level']."<br/><strong>Party: </strong> ".$fetch['party']?></center></h3></div>
							<div><h4><center><input type = "radio"  value = "<?php echo $fetch['candidate_id'] ?>" name = "as_id" class = "as">Give Vote</center></h4></div>
						</div>
